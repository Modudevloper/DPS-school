    ...
    <nav>
      ...
      >
        <div className="flex items-center justify-center">
          ...
          />
          <div className="hidden lg:flex flex-col justify-center ml-2 text-center">
            <span
              className={`font-bold ${
          ...
          <span
            className={`lg:hidden block text-sm ml-2 ${
              isScrolled ? "text-gray-800" : "text-white"
            }`}
          >
            New DPS School
        ...
        <div className="hidden lg:flex space-x-4">
          ...
          <Link
            to="/contact"
            className="btn btn-primary shadow text-light text-sm px-4 py-2 rounded-l-full rounded-r-full"
          >
            Admission & Contact
          </Link>
        </div>
