          ...
          <div className='h-[25rem] lg:h-[40rem]'>
            <div className='bg-black bg-opacity-50 w-full h-full flex flex-col justify-center items-center'>
              <div className='flex flex-col justify-center items-center'>
                ...
                <h4 className='lg:text-2xl text-lg text-white mt-3 font-bold'>Palwal</h4>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className='h-[25rem] lg:h-[40rem]'>
            <div className='bg-black bg-opacity-50 w-full h-full flex flex-col justify-center items-center'>
              <div className='flex flex-col justify-center items-center'>
                ...
                <h4 className='lg:text-xl text-lg text-white mt-3 font-bold'>Palwal</h4>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className='h-[25rem] lg:h-[40rem]'>
            <div className='bg-black bg-opacity-50 w-full h-full flex flex-col justify-center items-center'>
              <div className='flex flex-col justify-center items-center'>
                ...
                <h4 className='lg:text-xl text-sm text-white mt-3 font-bold'>Palwal</h4>
              </div>
            </div>
          </div>
        </div>
